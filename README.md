...
<p>
  Your users write one sentence. Feedbackland titles it, files it, merges the duplicates —<br>
  and turns the whole board into a ranked list of what to build, with the arithmetic shown.
</p>
